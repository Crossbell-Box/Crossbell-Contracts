...
```solidity
event GrantOperatorPermissions(uint256 characterId, address operator, uint256 permissionBitMap, uint256 timestamp)
```

### GrantOperatorPermissions4Note

```solidity
event GrantOperatorPermissions4Note(uint256 characterId, uint256 noteId, address operator, uint256 permissionBitMap, uint256 timestamp)
```
