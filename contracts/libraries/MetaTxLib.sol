...
library MetaTxLib {
    ...
    // solhint-disable-next-line private-vars-leading-underscore, var-name-mixedcase
    bytes32 internal constant GRANT_OPERATOR_PERMISSIONS_WITH_SIG_TYPEHASH = keccak256( // solhint-disable-next-line max-line-length
    ...
    function validateGrantOperatorPermissionsSignature(
        ...
        _validateRecoveredAddress(ECDSA.toTypedDataHash(_calculateDomainSeparator(), hashedMessage), signature);
    }
