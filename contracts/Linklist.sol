...
import {ErrCallerNotWeb3Entry, ErrCallerNotWeb3EntryOrNotOwner, ErrTokenNotExists} from "./libraries/Error.sol";
...
contract Linklist is ILinklist, LinklistBase, LinklistStorage, Initializable, LinklistExtendStorage {
    ...
    /// @inheritdoc ILinklist
    function setLinkType(uint256 tokenId, bytes32 linkType)
        external
        override
        onlyWeb3Entry
    ...
    /// @inheritdoc ILinklist
    function removeLinkingNote(uint256 tokenId, uint256 toCharacterId, uint256 toNoteId)
        external
        override
        onlyWeb3Entry
    {
        ...
        returns (bytes32)
    {
        ...
        _linkingERC721s[linkKey] = DataTypes.ERC721Struct({tokenAddress: tokenAddress, erc721TokenId: erc721TokenId});
    ...
    /// @inheritdoc ILinklist
    function getLinkingAnyListLength(uint256 tokenId)
        external
        view
        override
        onlyExistingToken(tokenId)
